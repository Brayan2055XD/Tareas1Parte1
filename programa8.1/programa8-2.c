...
tanto para lectura como para escritura. Se utiliza ademas una funcion que recibe
...
void main(void)
{
    ...
    /* Observa  que las variables *a3, *a4 y *a5 se declaran como apuntadores de tipo
    estructura alumno. a6 es una variable de tipo estructura alumno. */

    a3 = &a0; /* En este caso al apuntador de tipo estructura alumno a3
    se le asigna la direccion de la variable de tipo estructura alumno. */

    a4 = new (struct alumno);
    /* Nota que el apuntador a4 es necesario asignarle una direccion de memoria.
    ...
    de los dos formatos siguientes:
                            ...
                            Apuntador.>campo
                                o  bien
                            (*apuntador).campo
    En la lectura de los campos de la variable a4 se utiliza como ejemplo ambos
    formatos. */
    ...
    Lectura(a5);   /* En este caso se pasa el apuntador a5 a la funcion lectura. */
