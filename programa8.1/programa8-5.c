...
/* El programa muestra la manera como se declara una union asi como la forma
de acceso a los campos de las variables de tipo union tanto para asignacion
...
void main(void)
{
    alumno a1 = {"Maria", "Contabilidad", 8.9, "5-158-40-50"}, a2, a3;
    /* Observa que solo el primer componente de una union puede recibir valores por
    medio de este tipo de asignaciones. */

    /* Para que puedas obervar las diferentes formas en que los campos de las
    ...
    scanf("%f", &a2.promedio);
    fflush(stdin);
    printf("Ingrese el correo eletrico: ");
    gets(a2.personales.correo);
    /* Observa que en la variable a2 de tipo estructura alumno el segundo campo de
    la union recibe un valor. */

    printf("Alumno 3\n");
    Lectura(&a3); /* Se llama a una funcion para leer los campos de la variables a3. */
    ...
    puts(a2.nombre);
    puts(a2.carrera);
    printf("%.2f\n", a2.promedio);   /* escribe basura. */
    puts(a2.personales.celular);     /* Escribe el contenido del segundo campo. */
    puts(a2.personales.correo);

    printf("Ingrese el telefono celular del alumnp 2: ");
    fflush(stdin);
    gets(a2.personales.correo);
    ...
    /* La funcion Lectura se utiliza para leer los campos de una variable
    de tipo estructura alumno. */
    {
