...
/* Estrucutra-1.
El programa la manera en que se declara una estructura, asi como la forma en que se tiene acceso a los campos de las
variables de tipo estructura tanto para asignacion de valores como para lectura y escritura. */
...
void main(void)
{
    ...
    /* Los campos a3 reciben valores por medio de asignaciones. */
    ...
    /* Observa otra forma de escribir los campos de la variable de tipo
    estructura a3. */
    printf("\nDatos del alumno 3\n");
