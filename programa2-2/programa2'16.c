...
/* Empresa textil
El programa, al recibir cm=omo datos decisivos la categoria
y antiguiedad de un empleado, determinar si el mismo reune las
condiciones establecidas por la empresa para ocupar
