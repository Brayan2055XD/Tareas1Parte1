...
if (isalpha (p1))
  ...
  if (isalpha (p1))
    if (isupper(p1))
    printf("%cfue convertida de mayuscula a minuscula \n", tolower(p1));
  /*La funcion tolowe convierte de mayuscula a minuscula. Si la letra es
  minuscula no la modifica. La funcion toupper, por otra parte, convierte de
  minuscula no la modifica. La funcion toupper, por otra parte, convierte
  de minuscula a mayuscula. Si la letra es mayuscula no la modifica. */
  else
    printf("%c es una letra minuscula \n", p1);
  else
      printf("%c no es una letra \n", p1);
