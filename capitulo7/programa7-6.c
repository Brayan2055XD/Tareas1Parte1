...
void main(void)
{
    ...
    menor que el de cad0, se genra un error en la ejecucion del programa. */
    ...
    reservado para cad2 es menor que lo que se pretende copiar, se genera un
    error en la ejecucion de programa. */
    ...
    printf("\nPrueba de la funcion strncpy. Se copian 3 caracteres de cad3 a cad2: %s\n",cad2);
    strcat(cad0, cad3);
    /* La funcion strcat permite incorporar una cadena de caracteres a otra cadena dad.
    En este caso se agrega la cadena cad3 a cad0. Si el espacio reservado para cad0
    es menor a lo que se debe almacenar se genera un error de ejecucion. */
    printf("\nPrueba de la funcion strcat. Se incorpora la cad3 a cad0: %s\n", cad0);
    strcat(cad1, " YY");
    ...
    a cad2. Si el espacio de cad2 es menor a lo que se debe almacenar ocurre un error de
    ejecuccion. */

    cad0 = strstr(cad0, "Mexico");
    printf("\nPrueba de la funcion strstr. Se trata de localizar la cadena Mexico dentro de cad0: %s\n", cad0);
    /*La funcion strstr se utiliza para localizar una cadena de caracteres dentro de otra cadena.
